...
<body>
    ...
    <?php 
        foreach ($nieuwsberichten as $kop => $nieuwsberichtdata) {
    ...
    <div class="content">
        ...
        <h2 class="title">
            <?php
                echo $nieuwsberichtdata[0]['titel'] . "<br>";
            ?>
        </h2>
        <p class="title">
            <?php
                echo $nieuwsberichtdata[0]['beschrijving'] . "<br>";
            ?>
        </p>
        <img src="<?php echo $nieuwsberichtdata[0]['image'] . "<br>"; ?> " class="title">
